        ...
        return _createClass(Ajax, [{
            ...
            key: "handleAjaxError", value: function (e, t, n) {
                ...
                switch (r.NP.done(), r.loading(!1), $(".btn-loading").buttonLoading(!1), e.status) {
                    ...
                    case 401:
                        return o.login ? location.href = o.login : r.error(r.lang[401] || "Unauthorized.");
                    case 419:
                ...
                e.removeErrors(), t.ajaxSubmit({
                    data: {_token: Dcat.token}, beforeSubmit: function (o, a, i) {
                        ...
                        if (r.buttonLoading(!1), !1 !== n.after(!1, o, e) && !1 !== n.error(o, e) && !1 !== U(H.error, o, e)) try {
                            ...
                            if (422 != o.status || !i || !Dcat.helpers.isset(i, "errors")) return Dcat.error(o.status + " " + o.statusText);
    ...
    var le = function () {
        ...
        return t = e, (n = [{
            key: "initSwitcher", value: function (e) {
                ...
                }, n = this, r = "dcat-admin-theme-mode", o = t.getItem(r), a = ".dark-mode-switcher i";

                function i(e) {
                    if (e) return $(a).addClass("icon-sun").removeClass("icon-moon"), void n.display(!0);
                    n.display(!1), $(a).removeClass("icon-sun").addClass("icon-moon")
                }

                "dark" === o ? i(!0) : "def" === o && i(!1), $(document).off("click", e).on("click", e, (function () {
                    $(a).toggleClass("icon-sun icon-moon"), $(a).hasClass("icon-moon") ? (i(!1), t.setItem(r, "def")) : (t.setItem(r, "dark"), i(!0))
                }))
            }
        }, {
            key: "toggle", value: function () {
        ...
        return t = e, (n = [{
            key: "boot", value: function (e) {
                ...
                $.pjax.defaults.timeout = 5e3, $.pjax.defaults.maxCacheLength = 0, $('a:not(a[target="_blank"])').click((function (e) {
                    ...
                    e.relatedTarget && e.relatedTarget.tagName && "form" === e.relatedTarget.tagName.toLowerCase() && $("form[pjax-container]").find('[type="submit"],.submit').buttonLoading(!1), $(".modal-backdrop").remove(), $("body").removeClass("modal-open")
